...
<title>Feiertags-Wochenplaner V26</title>
<style>
...
def main():
    ...
    st.set_page_config(page_title="Feiertags-Wochenplaner V26 – HTML Generator", page_icon="📅", layout="wide")
    st.markdown(
        """
        <style>
    ...
    st.title("Feiertags-Wochenplaner V26 – HTML Generator")
    st.caption("Excel + Normal_Tourenstart.csv + Kisoft_Kunden.csv hochladen → kompakte Dispo-HTML erzeugen. V26 priorisiert direkte Wochen-Referenzen desselben SAP und bestehende Tourmuster aus der gesamten Woche. Google Maps bleibt für jede Tour verfügbar; die interne Kartenansicht ist bewusst entfernt. ein oder mehrere Ausfalltage, Zieltag, Startbereich, Zeitrestriktionen, Tourgröße, Ladezeit und Ladefolge bleiben berücksichtigt.")
    ...
    if upload is None or starts_upload is None or info_upload is None:
        st.info("Für V26 bitte alle drei aktuellen Dateien hochladen. Benötigte Excel-Blätter: DIREKT, MK, HUPA_NMS und HUPA_MALCHOW.")
        return
    ...
    st.success("HTML wurde erzeugt. V26 prüft zuerst, ob derselbe SAP an anderen Tagen bereits auf einer Tour läuft, danach bestehende Tourmuster mit gemeinsamen Kunden und erst zuletzt reine Geo-Ähnlichkeit. Google Maps bleibt für jede Tour verfügbar; die interne Kartenansicht ist entfernt.")
    st.download_button(
        "Feiertags_Wochenplaner.html herunterladen",
        data=html.encode("utf-8"),
        file_name="Feiertags_Wochenplaner_V26.html",
        mime="text/html",
