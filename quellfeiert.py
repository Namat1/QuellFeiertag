...
<title>Feiertags-Wochenplaner V20</title>
<style>
...
<main>
  <section class="plannerbar">
    <div class="plannerflow">
      ...
      <button class="btn dangerbtn bigaction" id="cancelOutageBtn" type="button">Am Zieltag vorhanden → streichen</button>
      <div class="flowhint">Startbereich bleibt gleich · Wochen-Referenzen aktiv</div>
    </div>
  ...
  <div class="metrics compactmetrics">
    ...
    <div class="metric"><div class="v" id="mCancelled">0</div><div class="k">gestrichen</div></div>
  ...
  <section class="unplanned slimunplanned">
    <div class="unplanned-head"><div><span class="unplanned-title">Ausgeplant / gestrichen</span><span class="sub"> · hierher ziehen oder wieder zurück in eine Tour</span></div><span class="dropnote">Ablage</span></div>
...
def main():
    ...
    st.set_page_config(page_title="Feiertags-Wochenplaner V20 – HTML Generator", page_icon="📅", layout="wide")
    st.markdown(
        """
        <style>
    ...
    st.title("Feiertags-Wochenplaner V20 – HTML Generator")
    st.caption("Excel + Normal_Tourenstart.csv + Kisoft_Kunden.csv hochladen → kompakte Dispo-HTML erzeugen. Neue Touren werden in V20 zusätzlich anhand passender Referenztouren aus der gesamten Woche aufgebaut und als Geo-Skizze ab Valluhn visualisiert. Zusätzlich besitzt jede Tour einen Visualisieren-Button und einen Google-Maps-Button für die aktuelle Reihenfolge. Ausfalltag, Zieltag, Startbereich, Zeitrestriktionen, Tourgröße, Ladezeit und Ladefolge bleiben berücksichtigt.")
    ...
    if upload is None or starts_upload is None or info_upload is None:
        st.info("Für V20 bitte alle drei aktuellen Dateien hochladen. Benötigte Excel-Blätter: DIREKT, MK, HUPA_NMS und HUPA_MALCHOW.")
        return
    ...
    st.download_button(
        ...
        file_name="Feiertags_Wochenplaner_V20.html",
        mime="text/html",
