...
<title>Feiertags-Wochenplaner V25</title>
<style>
...
def main():
    ...
    st.set_page_config(page_title="Feiertags-Wochenplaner V25 – HTML Generator", page_icon="📅", layout="wide")
    st.markdown(
        """
        <style>
    ...
    st.title("Feiertags-Wochenplaner V25 – HTML Generator")
    st.caption("Excel + Normal_Tourenstart.csv + Kisoft_Kunden.csv hochladen → kompakte Dispo-HTML erzeugen. V25 priorisiert direkte Wochen-Referenzen desselben SAP und bestehende Tourmuster aus der gesamten Woche und nutzt die bekannte Tourstruktur für die Planung. Jede Tour besitzt weiterhin einen Google-Maps-Button für die aktuelle Reihenfolge; die interne Kartenansicht wurde entfernt. ein oder mehrere Ausfalltage, Zieltag, Startbereich, Zeitrestriktionen, Tourgröße, Ladezeit und Ladefolge bleiben berücksichtigt.")
    ...
    if upload is None or starts_upload is None or info_upload is None:
        st.info("Für V25 bitte alle drei aktuellen Dateien hochladen. Benötigte Excel-Blätter: DIREKT, MK, HUPA_NMS und HUPA_MALCHOW.")
        return
    ...
    st.success("HTML wurde erzeugt. V25 prüft zuerst, ob derselbe SAP an anderen Tagen bereits auf einer Tour läuft, danach bestehende Tourmuster mit gemeinsamen Kunden und erst zuletzt reine Geo-Ähnlichkeit. Neue Touren werden zusätzlich als Geo-Skizze ab Valluhn dargestellt.")
    st.download_button(
        "Feiertags_Wochenplaner.html herunterladen",
        data=html.encode("utf-8"),
        file_name="Feiertags_Wochenplaner_V25.html",
        mime="text/html",
