...
<title>Feiertags-Wochenplaner V21</title>
<style>
...
def main():
    ...
    st.set_page_config(page_title="Feiertags-Wochenplaner V21 – HTML Generator", page_icon="📅", layout="wide")
    st.markdown(
        """
        <style>
    ...
    st.title("Feiertags-Wochenplaner V21 – HTML Generator")
    st.caption("Excel + Normal_Tourenstart.csv + Kisoft_Kunden.csv hochladen → kompakte Dispo-HTML erzeugen. Neue Touren werden in V21 zusätzlich anhand passender Referenztouren aus der gesamten Woche aufgebaut und als Geo-Skizze ab Valluhn visualisiert. Zusätzlich besitzt jede Tour einen Visualisieren-Button und einen Google-Maps-Button für die aktuelle Reihenfolge. Ausfalltag, Zieltag, Startbereich, Zeitrestriktionen, Tourgröße, Ladezeit und Ladefolge bleiben berücksichtigt.")
    ...
    if upload is None or starts_upload is None or info_upload is None:
        st.info("Für V21 bitte alle drei aktuellen Dateien hochladen. Benötigte Excel-Blätter: DIREKT, MK, HUPA_NMS und HUPA_MALCHOW.")
        return
    ...
    st.download_button(
        ...
        file_name="Feiertags_Wochenplaner_V21.html",
        mime="text/html",
